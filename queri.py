...
# with Session(engine) as session:
#     users_delete = delete(Users).where(Users.id.between(5,25))
#     print(users_delete)
#     result = session.execute(users_delete)
#     session.commit()

# with Session(engine) as session:
#     users_delete = delete(Users).where(Users.id.between(27, 39))
#     session.execute(users_delete)
#     session.commit()

# print("✅ Deleted users from 27 to 39")
